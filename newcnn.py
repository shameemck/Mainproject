...
def read_dataset(path):
    ...
    for pa in my_list:
        ...
        print(pa,"==================",i)
        for root, dirs, files in os.walk(r'D:\public_complaint\public complaint\public complaint\src\static\dataset\\' + pa):

         for f in files:
            file_path = os.path.join(r'D:\public_complaint\public complaint\public complaint\src\static\dataset\\'+pa, f)
...
# predict(r"D:\public_complaint\public complaint\public complaint\src\static\dataset\G\images (22).jpeg")